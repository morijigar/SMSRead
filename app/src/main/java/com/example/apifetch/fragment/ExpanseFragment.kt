...
import com.example.apifetch.databinding.FragmentExpanseBinding
import com.example.apifetch.databinding.FragmentMainBinding
import com.example.apifetch.viewmodel.ExpanseFragmentViewModel
 ...
 */
class ExpanseFragment : BaseFragment<FragmentExpanseBinding, ExpanseFragmentViewModel>() {
    ...
    override val layoutId: Int
        get() = R.layout.fragment_expanse
    override val viewModel: ExpanseFragmentViewModel
        get() = ViewModelProvider(this).get(ExpanseFragmentViewModel::class.java)
    ...
    fun initData() {
        ...
        adapter = PostAdapter(baseActivity!!, SingletoneData.expanseArr)
